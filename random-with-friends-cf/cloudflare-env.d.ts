/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 654c6c687d63be201da2d2ab35336b83)
...
declare namespace Cloudflare {
	...
	interface Env {
		ROOMS: KVNamespace;
		PARTYSERVER_HOST: "http://localhost:8787" | "random-with-friends-cf.ccldd.workers.dev";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PARTYSERVER_HOST" | "NEXTJS_ENV">> {}
}
